...
import img from '../Images/Black Grey Simple Library Logo (4).png';
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                ...
                                <a className="nav-link my-2" href="/Home"> <b> Home </b></a>
                            ...
                            <li class="nav-item">
                                <a className="nav-link my-2" href="/Contact-us"> <b> Contact-us </b></a>

                            </li>
                            <li class="nav-item">
                                <a className="nav-link my-2" href="/About-us"> <b> About-us </b></a>
                    ...
                    <div class="col">
                        ...
                        </svg><Link to="tel:+15645446567" ><b> + 1 647-490-7292 </b>
                            </Link></p><br />
                        <p><i class="bi bi-whatsapp"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
                            ...
                            rel="noreferrer"> <b> + 1 647-490-7292 </b>
                            </Link></p><br />
                        ...
                        ><b> educationhelp24hr@gmail.com </b>
                            </Link></p>
                    ...
                    <div class="col">
                        ...
                        {/* <form ref={form} onSubmit={sendEmail}> */}
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="e.g john" />
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Message</label>
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                            </div> <br />
                            <button class="btn btn-primary" name="submit" type="submit" value="Send">Submit</button>
                        </form>
                    </div>
                </div>
