  ...
  return (
    <>
      ...
      <div class="jumbotron jumbotron-fluid">
                <img src="https://voyage.pictures/wp-content/uploads/2015/11/Contact-Us.jpg" class="   " alt="..." width={'100%'} height={'500px'} />
            </div>
        ...
        <div class="container my-3">
          <div class="row ">
            ...
            <div class="col-lg-6 my-5">
              <img src="https://media.istockphoto.com/id/1432010317/photo/communication-and-technology-and-cloud-concept-hand-putting-wooden-block-cube-symbol.jpg?s=612x612&w=0&k=20&c=mKM-tw9kvRFCmlurLjw7bIWHjHWWyqvvWih61oTzuIM=" class="img-fluid my-4" alt="..." />
      ...
      <div className="container my-4">
        <Row>
            ...
            <div className="container text-justify">
              <div className='my-5' >
                ...
                <div  >
                  ...
                  </svg> Email: educationhelp24hr@gmail.com
                  </p>
                  ...
                  </svg> Phone/Whatsapp:  + 1 647-490-7292
          ...
          <Col md={6}>
            <img src="https://media.istockphoto.com/id/695858734/photo/is-there-anything-else-i-can-help-with.jpg?s=612x612&w=0&k=20&c=ffz8OmoLt4mr1MX-cXXjbrUoxvSyCUvbwSW3PnrB5YA=" alt="" />
